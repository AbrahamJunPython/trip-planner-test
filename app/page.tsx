    ...
    <div className="p-6 text-center max-w-md mx-auto">
      ...
      <section className="mb-16">
        ...
        <button
          ...
          className="inline-flex items-center justify-center px-32 py-4 rounded-full font-semibold shadow-md transition outline-none border-0 text-[15px] bg-emerald-500 text-white cursor-pointer active:scale-[0.98] whitespace-nowrap"
        >
          はじめる
        </button>
      </section>
